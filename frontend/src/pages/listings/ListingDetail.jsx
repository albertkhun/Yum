...
export default function ListingDetail() {
  ...
  return (
    <div className="page-wrapper max-w-5xl mx-auto">
      ...
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-gray-500 hover:text-brand
            ...
            <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  <span className={`badge text-xs ${getCategoryColor(category)}`}>
                    {category}
                  </span>
              ...
              <button
                onClick={handleShare}
                className="p-2.5 rounded-xl border-2 border-gray-200 text-gray-500
          ...
          {facilities?.length > 0 && (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {facilities.map((f) => (
                  <div key={f}
                    className="flex items-center gap-2.5 bg-orange-50 rounded-xl px-3 py-2.5">
          ...
          <div className="sticky top-24 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6">
              ...
              <div className="flex items-center gap-3 p-3 bg-orange-50 rounded-xl mb-4
                ...
                <div className="w-10 h-10 bg-brand rounded-full flex items-center
                ...
                {vrMediaUrl && (
                  <button
                    ...
                    className="flex items-center justify-center gap-2.5 w-full
                               ...
                               transition-all text-sm shadow-sm shadow-orange-200"
                  >
                    <VRIcon />
